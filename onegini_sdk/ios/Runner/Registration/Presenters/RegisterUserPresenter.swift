...
class RegisterUserPresenter: RegisterUserPresenterProtocol {
    ...
    func presentCreatePinView(registerUserEntity: RegisterUserEntity) {
        ...
        if let error = registerUserEntity.pinError {
            ...
            OneginiModuleSwift.sharedInstance.submitPinAction(PinAction.provide.rawValue, isCreatePinFlow: NSNumber.init(value: 1), pin: OneginiModuleSwift.pinTestValue as NSString)
        }
    }
