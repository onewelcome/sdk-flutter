...
class _PinScreenState extends State<PinScreen> {
  ...
  Widget pinItem(String item){
    return item == null ? Container(width: 10,height: 2,color: Colors.black,) : Text("*",style: TextStyle(fontSize: 30),);
  }
...
class NumPad extends StatelessWidget {
  ...
  final Function done;
  const NumPad({Key key, this.enterNum, this.removeLast, this.done}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
      child: Column(
