...
List<StreamSubscription<OWEvent>> initPinAuthenticationSubscriptions(BuildContext context) {
...
StreamSubscription<OWEvent> _getOpenPinAuthSub(BuildContext context, PinScreenController pinScreenController) {
...
StreamSubscription<OWEvent> _getNextPinAuthAttemptSub(PinScreenController pinScreenController) {
