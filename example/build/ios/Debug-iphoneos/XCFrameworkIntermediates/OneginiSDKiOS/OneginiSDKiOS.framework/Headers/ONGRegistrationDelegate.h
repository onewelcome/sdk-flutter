 ...
 */
- (void)userClient:(ONGUserClient *)userClient didRegisterUser:(ONGUserProfile *)userProfile info:(ONGCustomInfo *_Nullable)info DEPRECATED_MSG_ATTRIBUTE("Use userClient:didRegisterUser:userProfile:identityProvider:info: method instead.");
 ...
 */
- (void)userClient:(ONGUserClient *)userClient didFailToRegisterWithError:(NSError *)error DEPRECATED_MSG_ATTRIBUTE("Use userClient:didFailToRegisterWithIdentityProvider:error: method instead.");
