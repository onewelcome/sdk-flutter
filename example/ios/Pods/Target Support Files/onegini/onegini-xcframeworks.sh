...
install_xcframework "${PODS_ROOT}/../.symlinks/plugins/onegini/ios/OneginiCrypto.xcframework" "OneginiCrypto" "framework" "ios-armv7_arm64" "ios-i386_x86_64-simulator"
install_xcframework "${PODS_ROOT}/../.symlinks/plugins/onegini/ios/OneginiSDKiOS.xcframework" "OneginiSDKiOS" "framework" "ios-armv7_arm64" "ios-i386_x86_64-simulator"
