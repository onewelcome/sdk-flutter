...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/onegini/onegini.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/qr_code_scanner/qr_code_scanner.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/OneginiCrypto/OneginiCrypto.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/OneginiSDKiOS/OneginiSDKiOS.framework"
fi
