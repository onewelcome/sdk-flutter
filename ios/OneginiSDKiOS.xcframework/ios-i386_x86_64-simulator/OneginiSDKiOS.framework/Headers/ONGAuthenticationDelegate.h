 ...
 *  @param userProfile currently authenticated user profile
 */
- (void)userClient:(ONGUserClient *)userClient didStartAuthenticationForUser:(ONGUserProfile *)userProfile DEPRECATED_MSG_ATTRIBUTE("Use -[ONGAuthenticationDelegate userClient:didStartAuthenticationForUser:authenticator:] method instead.");
 ...
 */
- (void)userClient:(ONGUserClient *)userClient didReceiveFingerprintChallenge:(ONGFingerprintChallenge *)challenge DEPRECATED_MSG_ATTRIBUTE("Use -[ONGAuthenticationDelegate userClient:didReceiveBiometricChallenge:] method instead.");
 ...
 *  @param customAuthInfo custom authenticator info about response from extension engine
 */
- (void)userClient:(ONGUserClient *)userClient didAuthenticateUser:(ONGUserProfile *)userProfile info:(nullable ONGCustomInfo *)customAuthInfo DEPRECATED_MSG_ATTRIBUTE("Use -[ONGAuthenticationDelegate userClient:didAuthenticateUser:authenticator:info:] method instead.");
 ...
 *  @param error error describing cause of an error. This error might include the ONGCustomInfo object into userInfo under the ONGCustomAuthInfoKey.
 */
- (void)userClient:(ONGUserClient *)userClient didFailToAuthenticateUser:(ONGUserProfile *)userProfile error:(NSError *)error DEPRECATED_MSG_ATTRIBUTE("Use -[ONGAuthenticationDelegate userClient:didFailToAuthenticateUser:authenticator:error:] method instead.");
