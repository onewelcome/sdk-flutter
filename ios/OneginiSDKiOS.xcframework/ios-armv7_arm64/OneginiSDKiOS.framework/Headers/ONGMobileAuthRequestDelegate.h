 ...
 */
- (void)userClient:(ONGUserClient *)userClient didReceiveFingerprintChallenge:(ONGFingerprintChallenge *)challenge forRequest:(ONGMobileAuthRequest *)request DEPRECATED_MSG_ATTRIBUTE("Use userClient:didReceiveBiometricChallenge:forRequest: method instead.");
 ...
 *  @see ONGMobileAuthRequest
 */
- (void)userClient:(ONGUserClient *)userClient didHandleMobileAuthRequest:(ONGMobileAuthRequest *)request info:(ONGCustomInfo *_Nullable)customAuthenticatorInfo DEPRECATED_MSG_ATTRIBUTE("Use userClient:didHandleMobileAuthRequest:authenticator:info: method instead.");
 ...
 *  @see ONGMobileAuthRequest
 */
- (void)userClient:(ONGUserClient *)userClient didFailToHandleMobileAuthRequest:(ONGMobileAuthRequest *)request error:(NSError *)error DEPRECATED_MSG_ATTRIBUTE("Use userClient:didFailToHandleMobileAuthRequest:authenticator:error: method instead.");
