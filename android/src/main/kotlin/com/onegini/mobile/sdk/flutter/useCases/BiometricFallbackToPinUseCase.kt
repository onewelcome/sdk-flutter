...
@Singleton
class BiometricFallbackToPinUseCase @Inject constructor(private val biometricAuthRequestHandler: BiometricAuthenticationRequestHandler,
  ...
  operator fun invoke(callback: (Result<Unit>) -> Unit) {
    ...
    biometricAuthRequestHandler.CALLBACK?.fallbackToPin()
