...
@Singleton
class GetUnauthenticatedResourceUseCase @Inject constructor(private val oneginiSDK: OneginiSDK) {
    operator fun invoke(call: MethodCall, result: MethodChannel.Result, resourceHelper: ResourceHelper) {
        val okHttpClient: OkHttpClient = oneginiSDK.oneginiClient.deviceClient.unauthenticatedResourceOkHttpClient
