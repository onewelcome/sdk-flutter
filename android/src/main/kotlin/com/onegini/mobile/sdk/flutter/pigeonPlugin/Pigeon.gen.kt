...
data class OWAuthenticator (
  ...
  val authenticatorType: OWAuthenticatorType
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): OWAuthenticator {
      ...
      val authenticatorType = OWAuthenticatorType.ofRaw(list[4] as Int)!!
...
interface UserClientApi {
  ...
  fun registerStatelessUser(identityProviderId: String?, scopes: List<String>?, callback: (Result<OWRegistrationResponse>) -> Unit)
  ...
  fun registerBiometricAuthenticator(callback: (Result<Unit>) -> Unit)
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: UserClientApi?) {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            val identityProviderIdArg = args[0] as String?
            val scopesArg = args[1] as List<String>?
            api.registerStatelessUser(identityProviderIdArg, scopesArg) { result: Result<OWRegistrationResponse> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val profileIdArg = args[0] as String
            val authenticatorTypeArg = OWAuthenticatorType.ofRaw(args[1] as Int)!!
            api.authenticateUser(profileIdArg, authenticatorTypeArg) { result: Result<OWRegistrationResponse> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.UserClientApi.getPreferredAuthenticator", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val profileIdArg = args[0] as String
            api.getPreferredAuthenticator(profileIdArg) { result: Result<OWAuthenticator> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val authenticatorTypeArg = OWAuthenticatorType.ofRaw(args[0] as Int)!!
            api.setPreferredAuthenticator(authenticatorTypeArg) { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.UserClientApi.deregisterBiometricAuthenticator", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            api.deregisterBiometricAuthenticator() { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.UserClientApi.registerBiometricAuthenticator", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            api.registerBiometricAuthenticator() { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.UserClientApi.biometricFallbackToPin", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            api.biometricFallbackToPin() { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.UserClientApi.biometricDenyAuthenticationRequest", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            api.biometricDenyAuthenticationRequest() { result: Result<Unit> ->
              val error = result.exceptionOrNull()
              if (error != null) {
                reply.reply(wrapError(error))
              } else {
...
class NativeCallFlutterApi(private val binaryMessenger: BinaryMessenger) {
  ...
  fun n2fFinishBiometricAuthentication(callback: () -> Unit) {
    val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.NativeCallFlutterApi.n2fFinishBiometricAuthentication", codec)
    channel.send(null) {
      callback()
    }
  }
