...
class IsBiometricAuthenticatorAvailableUseCase @Inject constructor(private val oneginiSDK: OneginiSDK) {
    operator fun invoke(profileId: String, callback: (Result<Boolean>) -> Unit) {
        ...
        authenticators.find { it.type ==  OneginiAuthenticator.FINGERPRINT }
