...
class OnMethodCallMapper(private var context: Context, private val oneginiMethodsWrapper: OneginiMethodsWrapper) : MethodChannel.MethodCallHandler {
    ...
    override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: MethodChannel.Result) {
        when (call.method) {
            ...
            Constants.METHOD_CUSTOM_TWO_STEP_REGISTRATION_RETURN_SUCCESS -> oneginiMethodsWrapper.customTwoStepRegistrationActionReturnSuccess(call, CustomTwoStepRegistrationAction.CALLBACK)
            Constants.METHOD_CUSTOM_TWO_STEP_REGISTRATION_RETURN_ERROR -> oneginiMethodsWrapper.customTwoStepRegistrationActionReturnError(call, CustomTwoStepRegistrationAction.CALLBACK)
            ...
            Constants.METHOD_ACCEPT_PIN_REGISTRATION_REQUEST -> oneginiMethodsWrapper.pinRequestHandlerAcceptAuthenticationRequest(call, PinRequestHandler.CALLBACK)
            Constants.METHOD_DENY_PIN_REGISTRATION_REQUEST -> oneginiMethodsWrapper.pinRequestHandlerDenyAuthenticationRequest(PinRequestHandler.CALLBACK)
            ...
            Constants.METHOD_ACCEPT_PIN_AUTHENTICATION_REQUEST -> oneginiMethodsWrapper.pinAuthenticationRequestHandlerAcceptAuthenticationRequest(call, PinAuthenticationRequestHandler.CALLBACK)
            Constants.METHOD_DENY_PIN_AUTHENTICATION_REQUEST -> oneginiMethodsWrapper.pinAuthenticationRequestHandlerDenyAuthenticationRequest(PinAuthenticationRequestHandler.CALLBACK)

            // Fingerprint
            Constants.METHOD_ACCEPT_FINGERPRINT_AUTHENTICATION_REQUEST -> oneginiMethodsWrapper.fingerprintAuthenticationRequestHandlerAcceptAuthenticationRequest(FingerprintAuthenticationRequestHandler.fingerprintCallback)
            Constants.METHOD_DENY_FINGERPRINT_AUTHENTICATION_REQUEST -> oneginiMethodsWrapper.fingerprintAuthenticationRequestHandlerDenyAuthenticationRequest(FingerprintAuthenticationRequestHandler.fingerprintCallback)
            Constants.METHOD_FINGERPRINT_FALL_BACK_TO_PIN -> oneginiMethodsWrapper.fingerprintAuthenticationRequestHandlerFallbackToPin(FingerprintAuthenticationRequestHandler.fingerprintCallback)
            ...
            Constants.METHOD_ACCEPT_OTP_AUTHENTICATION_REQUEST -> oneginiMethodsWrapper.mobileAuthOtpRequestHandlerAcceptAuthenticationRequest(MobileAuthOtpRequestHandler.CALLBACK)
            Constants.METHOD_DENY_OTP_AUTHENTICATION_REQUEST -> oneginiMethodsWrapper.mobileAuthOtpRequestHandlerDenyAuthenticationRequest(MobileAuthOtpRequestHandler.CALLBACK)
