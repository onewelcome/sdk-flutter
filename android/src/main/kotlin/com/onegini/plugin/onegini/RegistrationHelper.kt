...
class RegistrationHelper {
    companion object{
        ...
        fun registerUser(packageContext: Context?, @Nullable identityProvider: OneginiIdentityProvider?, registrationHandler: OneginiRegistrationHandler?) {
            val oneginiClient: OneginiClient? = OneginiSDK.getOneginiClient(packageContext)
            oneginiClient?.userClient!!.registerUser(identityProvider, Constants.DEFAULT_SCOPES, registrationHandler!!)
        }
