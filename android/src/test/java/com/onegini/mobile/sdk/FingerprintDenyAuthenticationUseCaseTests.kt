...
import com.onegini.mobile.sdk.flutter.useCases.FingerprintDenyAuthenticationUseCase
...
class FingerprintDenyAuthenticationUseCaseTests {
    @Mock
    ...
    fun `should call denyAuthenticationRequest`() {
        ...
        FingerprintDenyAuthenticationUseCase(oneginiSDKMock)()
