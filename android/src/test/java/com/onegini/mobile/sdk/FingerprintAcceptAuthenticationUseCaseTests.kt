...
import com.onegini.mobile.sdk.flutter.useCases.FingerprintAcceptAuthenticationUseCase
...
class FingerprintAcceptAuthenticationUseCaseTests {
    ...
    @Test
    fun `should call acceptAuthenticationRequest`() {
        ...
        FingerprintAcceptAuthenticationUseCase(oneginiSDKMock)()
